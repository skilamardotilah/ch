...
export default function Footer() {
  return (
    <footer className="w-full text-white border-t border-gray-600 py-[60px] px-4 md:px-[80px]">
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between gap-[40px] text-sm">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            <img
              src={asset("img/movie.png")}
              alt="Chill Logo"
              className="md:w-[50px] md:h-auto w-[28px] h-[25px]"
            />
            <span className="md:text-[50px] text-[24px] leading-[55px] font-normal font-['Londrina_Solid']">
              CHILL
            </span>
          </div>
        ...
        <div className="md:hidden flex flex-col space-y-2">
          <details className="group">
            <summary className="font-medium text-[16px] cursor-pointer flex justify-between items-center py-1">
              Genre
              <span className="text-white-400 text-[24px] group-open:rotate-90 transition-transform">
                ›
              </span>
            </summary>
